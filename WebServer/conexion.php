...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Conexión FTP</h3>
                ...
                <div class="card-body">
                    Consigue acceso a todos tus archivos mediante una conexión FTP!
                </div>
                <!-- /.card-body -->
        ...
        <section class="content">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Conexión SSH</h3>
                ...
                <div class="card-body">
                    Ejecuta todas tus prácticas de Sistemas Operativos remotamente!
                </div>
                <!-- /.card-body -->
                <div class="card-footer">
                    Footer
